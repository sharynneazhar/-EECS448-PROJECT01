...
\index{Note\+Reader@{Note\+Reader}!Note\+Reader@{Note\+Reader}}
\subsubsection[{\texorpdfstring{Note\+Reader(std\+::string file)}{NoteReader(std::string file)}}]{\setlength{\rightskip}{0pt plus 5cm}Note\+Reader\+::\+Note\+Reader (
...
\subsubsection[{\texorpdfstring{read\+Note()}{readNote()}}]{\setlength{\rightskip}{0pt plus 5cm}std\+::string Note\+Reader\+::read\+Note (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
