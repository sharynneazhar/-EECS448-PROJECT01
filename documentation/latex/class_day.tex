...
\subsubsection[{\texorpdfstring{contain(\+Day $\ast$days\+With\+Events, int size)}{contain(Day *daysWithEvents, int size)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Day\+::contain (
\begin{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{update\+Arr(\+Day $\ast$days\+With\+Events, int size)}{updateArr(Day *daysWithEvents, int size)}}]{\setlength{\rightskip}{0pt plus 5cm}void Day\+::update\+Arr (
\begin{DoxyParamCaption}
\item[{{\bf Day} $\ast$}]{days\+With\+Events, }
\item[{int}]{size}
\end{DoxyParamCaption}
